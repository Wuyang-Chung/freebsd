 ...
 *   /nfs/vm.FreeBSD/sys/dev/sound/pcm/channel_if.m
 * with
 *   makeobjops.awk
 *
...
struct kobjop_desc channel_init_desc = {
	0, { &channel_init_desc, (kobjop_t)kobj_error_method }
};

struct kobjop_desc channel_free_desc = {
	0, { &channel_free_desc, (kobjop_t)channel_nofree }
};

struct kobjop_desc channel_reset_desc = {
	0, { &channel_reset_desc, (kobjop_t)channel_noreset }
};

struct kobjop_desc channel_resetdone_desc = {
	0, { &channel_resetdone_desc, (kobjop_t)channel_noresetdone }
};

struct kobjop_desc channel_setformat_desc = {
	0, { &channel_setformat_desc, (kobjop_t)kobj_error_method }
};

struct kobjop_desc channel_setspeed_desc = {
	0, { &channel_setspeed_desc, (kobjop_t)kobj_error_method }
};

struct kobjop_desc channel_setblocksize_desc = {
	0, { &channel_setblocksize_desc, (kobjop_t)kobj_error_method }
};

struct kobjop_desc channel_setfragments_desc = {
	0, { &channel_setfragments_desc, (kobjop_t)channel_nosetfragments }
};

struct kobjop_desc channel_trigger_desc = {
	0, { &channel_trigger_desc, (kobjop_t)kobj_error_method }
};

struct kobjop_desc channel_getptr_desc = {
	0, { &channel_getptr_desc, (kobjop_t)channel_nogetptr }
};

struct kobjop_desc channel_getcaps_desc = {
	0, { &channel_getcaps_desc, (kobjop_t)kobj_error_method }
};

struct kobjop_desc channel_notify_desc = {
	0, { &channel_notify_desc, (kobjop_t)channel_nonotify }
};

struct kobjop_desc channel_getpeaks_desc = {
	0, { &channel_getpeaks_desc, (kobjop_t)channel_nogetpeaks }
};

struct kobjop_desc channel_getrates_desc = {
	0, { &channel_getrates_desc, (kobjop_t)channel_nogetrates }
};

struct kobjop_desc channel_getmatrix_desc = {
	0, { &channel_getmatrix_desc, (kobjop_t)channel_nogetmatrix }
};

struct kobjop_desc channel_setmatrix_desc = {
	0, { &channel_setmatrix_desc, (kobjop_t)channel_nosetmatrix }
};
