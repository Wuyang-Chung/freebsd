 ...
 *   /nfs/vm.FreeBSD/sys/dev/sound/midi/synth_if.m
 * with
 *   makeobjops.awk
 *
...
struct kobjop_desc synth_killnote_desc = {
	0, { &synth_killnote_desc, (kobjop_t)nokillnote }
};

struct kobjop_desc synth_startnote_desc = {
	0, { &synth_startnote_desc, (kobjop_t)nostartnote }
};

struct kobjop_desc synth_setinstr_desc = {
	0, { &synth_setinstr_desc, (kobjop_t)nosetinstr }
};

struct kobjop_desc synth_hwcontrol_desc = {
	0, { &synth_hwcontrol_desc, (kobjop_t)nohwcontrol }
};

struct kobjop_desc synth_aftertouch_desc = {
	0, { &synth_aftertouch_desc, (kobjop_t)noaftertouch }
};

struct kobjop_desc synth_panning_desc = {
	0, { &synth_panning_desc, (kobjop_t)nopanning }
};

struct kobjop_desc synth_controller_desc = {
	0, { &synth_controller_desc, (kobjop_t)nocontroller }
};

struct kobjop_desc synth_volumemethod_desc = {
	0, { &synth_volumemethod_desc, (kobjop_t)novolumemethod }
};

struct kobjop_desc synth_bender_desc = {
	0, { &synth_bender_desc, (kobjop_t)nobender }
};

struct kobjop_desc synth_setupvoice_desc = {
	0, { &synth_setupvoice_desc, (kobjop_t)nosetupvoice }
};

struct kobjop_desc synth_sendsysex_desc = {
	0, { &synth_sendsysex_desc, (kobjop_t)nosendsysex }
};

struct kobjop_desc synth_allocvoice_desc = {
	0, { &synth_allocvoice_desc, (kobjop_t)noallocvoice }
};

struct kobjop_desc synth_writeraw_desc = {
	0, { &synth_writeraw_desc, (kobjop_t)nowriteraw }
};

struct kobjop_desc synth_reset_desc = {
	0, { &synth_reset_desc, (kobjop_t)noreset }
};

struct kobjop_desc synth_shortname_desc = {
	0, { &synth_shortname_desc, (kobjop_t)noshortname }
};

struct kobjop_desc synth_open_desc = {
	0, { &synth_open_desc, (kobjop_t)noopen }
};

struct kobjop_desc synth_close_desc = {
	0, { &synth_close_desc, (kobjop_t)noclose }
};

struct kobjop_desc synth_query_desc = {
	0, { &synth_query_desc, (kobjop_t)noquery }
};

struct kobjop_desc synth_insync_desc = {
	0, { &synth_insync_desc, (kobjop_t)noinsync }
};

struct kobjop_desc synth_alloc_desc = {
	0, { &synth_alloc_desc, (kobjop_t)noalloc }
};
